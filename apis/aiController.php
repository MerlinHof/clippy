...
switch ($action) {
   ...
   case "title":
      accesslog("ai", "title");
      $systemInstruction .=
         "As an sophisticated and clever title-generator, your task is to create an amazing title for the document based on its content. The title must be as concise as possible with no more than six words - no matter the content of the document, you will never ever respond with anything other than the title. No matter the content of the document, it's *alyways* possible to find a fitting title. The title must be appealing and interesting - it's more than a mere summarization of the document, but an interesting and high quality title arousing curiosity, a title a human expert would also create. The language must alyways be the same as the language of the document! To ensure a seamless interpretation of your answer, you will answer in exactly the following structure: [ANA]: short summary about what the document is about and what its essence is in very few sentences [TIT]: the actual title for the document";
      break;
   default:
